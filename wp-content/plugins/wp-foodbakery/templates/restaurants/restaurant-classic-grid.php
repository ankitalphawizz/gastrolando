...
if ($restaurant_loop_obj->have_posts()) {
    ...
    <div class="listing classic-grid">
		...
		$foodbakery_restaurant_table_booking = get_post_meta($restaurant_id, 'foodbakery_restaurant_table_booking', true);
			...
			<div class="text-holder">
				...
				if ($foodbakery_restaurant_table_booking == 'yes') {
	    			...
	    			<div class="post-time">
	    			    <i class="icon-food"></i>
	    			    <div class="time-tooltip">
	    				<div class="time-tooltip-holder"> <b class="tooltip-label"><?php esc_html_e('Book a table', 'foodbakery') ?></b> <b class="tooltip-info">
						<?php printf(esc_html__('You can book a table in this restaurant', 'foodbakery'), esc_html($restaurant_pickup_time)); ?>
						</b> </div>
	    			    </div>
	    			</div>
				    <?php
