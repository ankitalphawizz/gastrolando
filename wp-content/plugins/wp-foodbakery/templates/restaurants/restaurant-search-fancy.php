...
<div class="main-search fancy bg-holder">
    <form name="foodbakery-restaurant-form" id="frm_restaurant_arg<?php echo intval( $rand_numb ); ?>" action="<?php echo esc_html( $foodbakery_search_result_page ); ?>" >
        ...
        $search_title_column_size = 'col-lg-6 col-md-6 col-sm-5 col-xs-12';
        $search_title_column_size = apply_filters('foodbakery_search_title_column_size', $search_title_column_size);
        ?>
        <div class="row">
            <div class="<?php echo esc_attr( $search_title_column_size ); ?>">
            ...
            <?php do_action('foodbakery_restaurants_search_filters', $rand_numb); ?>
