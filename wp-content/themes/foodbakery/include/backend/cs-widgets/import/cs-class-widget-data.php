                                        ...
                                        <div class="widgets">
                                            ...
                                            foreach ($widget_list as $widget) :
                                                ...
                                                <div class="import-form-row">
                                                    <input class="<?php echo foodbakery_allow_special_char($sidebar_name == 'wp_inactive_widgets') ? 'inactive' : 'active'; ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr($widget); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
                                            ...
                                            <div class="sidebar">
                                                ...
                                                <div class="widgets">
                                                    ...
                                                    foreach ($widget_list as $widget) :
                                                        ...
                                                        ?>
                                                        <div class="import-form-row">
                                                            <input class="<?php echo foodbakery_allow_special_char($sidebar_name == 'wp_inactive_widgets') ? 'inactive' : 'active'; ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr(printf('widgets[%s][%d]', $widget_type, $widget_type_index)); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
